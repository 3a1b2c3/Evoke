...
class BucketedSampler(Sampler):
    ...
    def _shard_indices_for_sp_group(self, indices):
        """Return the subset of indices belonging to this SP group."""
        ...
        # Each SP group gets every num_sp_groups-th element
    ...
    def __iter__(self):
        ...
        for bucket_key, dataset_groups in self.dataset_buckets.items():
            ...
            # Global shuffle before sharding for distributed consistency
            if self.shuffle:
