                    ...
                    output_dict.update(
                        {
                            ...
                            # v2v ODE warp condition; absent from t2v .pt files, hence None.
...
class BucketedSampler(Sampler):
    ...
    def _shard_indices_for_sp_group(self, indices):
        """Shard indices so each SP group receives a disjoint subset."""
        ...
        # Pad or truncate to be divisible by num_sp_groups
        ...
        # Each SP group takes every num_sp_groups-th element starting at its rank
    ...
    def __iter__(self):
        ...
        # Shuffle globally before sharding for distributed consistency
        if self.shuffle:
    ...
    def __len__(self):
        ...
        # Samples assigned to this SP group
...
if __name__ == "__main__":
    ...
    # point these at your own pre-extracted latent / text-embedding directories
